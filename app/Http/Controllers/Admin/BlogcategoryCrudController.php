...
class BlogcategoryCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setEntityNameStrings('blogcategory', 'blogcategories');
    }
    ...
    {
        CRUD::addColumn(['name' => 'id', 'label' => 'ID', 'type' => 'varchar']);
        CRUD::addColumn(['name' => 'name', 'label' => 'Name', 'type' => 'varchar']);
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('name')->type('text')->label('Add Name');
