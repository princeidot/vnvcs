              ...
              <div class="main-menu-wrapper clearfix">
                  <div class="main-menu-wrapper-inner clearfix">
                      <div class="main-menu-wrapper__left clearfix">
                          <div class="main-menu-wrapper__logo"> <a href="{{url('/')}}"><img src="{{asset('images/vnvcs/logo-1.png')}}" alt="" style="height:55px;"></a> <!-- <span style="width:100%;margin-left:4px;">ISO 9001:2015</span><br>                              <span style="width:100%;margin-top:-30px;margin-left: 210px;">ISO/IEC 20000-1:2018</span> -->
                          </div>
                          <div class="main-menu-wrapper__main-menu"> <a href="#" class="mobile-nav__toggler"><i class="fa fa-bars"></i></a>
                              <ul class="main-menu__list" style="margin-left: 70px;">
                                          ...
                                          <li>
                                              <div class="row" style="padding: 15px;">
                                                  <div class="col-md-4 ">
                                                      ...
                                                      </a> <a href="products#focus" class="subtitle " style="padding-top: 0px;padding-bottom: 10px;">
                                                  ...
                                                  <div class="col-md-4 p-border">
                                                      ...
                                                      </a> <a href="produtcs#satm" class="subtitle " style="padding-top: 0px;padding-bottom: 10px;">
                                                  ...
                                                  <div class="col-md-4 p-border">
                                                      <div class="title">Logistics</div> <a href="{{url('cfsmag-ee')}}" class="subtitle " style="padding-top: 0px;padding-bottom: 10px;">
                                                          <div id="DivForHoverItem">CFSMag<sup>+</sup>&nbsp;&nbsp;EE </div>
                                  ...
                                  <li class="dropdown"><a href="#">Insights <i class="fa fa-angle-down in"></i></a>
                                      <ul class="dropdown-menu" style="min-width:200px;left:0px;border-radius:20px;">
                                          <li>
                      ...
                      <div class="main-menu-wrapper__right">
                          <div class="main-menu-wrapper__call"> <a href="#" class="main-menu-wrapper__search search-toggler icon-magnifying-glass"></a> </div>
                          <div class="main-menu-wrapper__search-box-cart-box" style="padding: 4.5px 0;    margin-top: -9px;">
                              <div class="main-menu-wrapper__call-icon" style="margin-left: 22px;"> <a href=" tel:9152123651">
                                      <div class="tooltip"> <img src="{{asset('images/shapes/phone-icon.png')}}" alt=""> <span class="tooltiptext">+91-9152123651 / 52</span> </div>
                                  </a> </div>
                              <div class="social"> <a href="https://www.linkedin.com/company/vnvcs/" target="_blank"> <i class="fab fa-linkedin" aria-hidden="true" style="color:#0e76a8"></i></a> <i class="fab fa-twitter" aria-hidden="true" style="margin-left:22px;color:  #00acee"></i> </div>
                          </div>
                      </div>
                  </div>
              </div>
  ...
  <div class="mobile-view">
      <header class="nav-top"> <a href="{{url('')}}"> <img src="{{asset('images/menu.png')}}" style="width: 140px;"></a> <span class="hamburger material-icons" id="ham"> <i class="fa fa-bars" style="color:black;" aria-hidden="true"></i></span> </header>
      <nav class="nav-drill">
          <ul class="nav-items nav-level-1" style="list-style-type: none;padding-left: 0rem;">
              ...
              <li class="nav-item nav-expand"> <a class="nav-link nav-expand-link" href="#"> Product </a>
                  <ul class="nav-items nav-expand-content" style="list-style-type: none;padding-left: 0rem;">
                      ...
                      <li class="nav-item nav-expand"> <a class="nav-link nav-expand-link" href="#"> Logistics </a>
                          <ul class="nav-items nav-expand-content" style="list-style-type: none;padding-left: 0rem;">
                              <li class="nav-item"> <a class="nav-link" href="{{'cfsmag-ee'}}"> CFSMag<sup>+</sup> &nbsp;&nbsp;EE </a> </li>
              ...
              <li class="nav-item nav-expand"> <a class="nav-link nav-expand-link" href="#"> Services & Support </a>
                  <ul class="nav-items nav-expand-content">
                      <li class="nav-item nav-expand"> <a class="nav-link nav-expand-link" href="#"> Services </a>
                          <ul class="nav-items nav-expand-content">
                              <li class="nav-item"> <a class="nav-link" href="services#cloudservices"> Cloud Services </a> </li>
                              <li class="nav-item"> <a class="nav-link" href="services#projectdelivery"> Project delivery </a> </li>
                              <li class="nav-item"> <a class="nav-link" href="services#ondemandit"> On Demand IT </a> </li>
                              <li class="nav-item"> <a class="nav-link" href="services#softwareservices"> Product Implementation Service</a> </li>
                              <li class="nav-item"> <a class="nav-link" href="services#projectmanagement"> Project Management </a> </li>
                              <li class="nav-item"> <a class="nav-link" href="services#trainingservices"> Training services </a> </li>
                          </ul>
                      </li>
                      <li class="nav-item nav-expand"> <a class="nav-link nav-expand-link" href="#"> Support </a>
                          <ul class="nav-items nav-expand-content">
                              <li class="nav-item"> <a class="nav-link" href="services#productsupport"> Product support </a> </li>
                              <li class="nav-item"> <a class="nav-link" href="services#basedsupport"> SLA based support </a> </li>
                              <li class="nav-item"> <a class="nav-link" href="services#onsiteitmanpower"> Onsite IT Manpower </a> </li>
                              <li class="nav-item"> <a class="nav-link" href="services#postsalesupport"> Post-Sales support </a> </li>
                              <li class="nav-item"> <a class="nav-link" href="services#ticketingsystem"> Ticketing System </a> </li>
                          </ul>
                      </li>
                      <li class="nav-item nav-expand"> <a class="nav-link nav-expand-link" href="#"> Consultancy </a>
                          <ul class="nav-items nav-expand-content">
                              <li class="nav-item"> <a class="nav-link" href="services#projectconsultancy"> Project Consultancy </a> </li>
                              <li class="nav-item"> <a class="nav-link" href="services#operationalconsultancy"> Operational Consultancy </a> </li>
                              <li class="nav-item"> <a class="nav-link" href="services#solutionroadmap"> Solution Roadmap </a> </li>
                              <li class="nav-item"> <a class="nav-link" href="services#manageditsolutions"> Managed IT solutions </a> </li>
                          </ul>
                      </li>
                  </ul>
              </li>
              <li class="nav-item nav-expand"> <a class="nav-link nav-expand-link" href="#"> Insights </a>
                  <ul class="nav-items nav-expand-content" style="list-style-type: none;padding-left: 0rem;">
                      ...
                      <li class="nav-item"> <a class="nav-link" href="{{url('news-and-event')}}"> News & Event </a> </li>
                      <li class="nav-item"> <a class="nav-link" href="{{url('case-studies')}}"> Case Studies </a> </li>
                  </ul>
              </li> <!-- <li class="nav-item">                 <a class="nav-link" href="#">                     Directory                 </a>             </li> -->
          </ul>
      </nav>
  </div> <a href="{{url('cfsmag-ee')}}">
