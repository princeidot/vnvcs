            ...
            <div class="site-footer__top-inner">
                ...
                <div class="row">
                        ...
                        <div class="footer-widget__column footer-widget__about">
                            ...
                            <div class="footer-widget__about-social"> <a href="#" target="_blank"><i
                                    ...
                                    href="https://www.linkedin.com/company/vnvcs/" target="_blank"><i
                                        class="fa fa fa-linkedin-square"></i></a> <a href="https://wa.me/919152123651"
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <div class="certificate" style="margin-top:12px;"> <img src="{{asset('images/vnvcs/isa.png')}}"
                                style="width:47%"> </div>
                    </div>
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="footer-widget__column footer-widget__links clearfix">
                            <h3 class="footer-widget__title" style="margin-left:-14px">Links</h3>
                            <ul class="footer-widget__links-list list-unstyled clearfix"
                                style="margin-right: 13px;margin-left: -11px;">
                            ...
                            <div class="certificate" style="margin-top:21px;"> <img src="{{asset('images/vnvcs/ifa.png')}}" style="width:50%;"> <img
                                    src="{{asset('images/vnvcs/egac.png')}}" style="width:45%;">
                            </div>
                    </div>
